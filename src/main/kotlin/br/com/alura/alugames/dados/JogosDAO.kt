...
class JogosDAO(val manager: EntityManager) {
    ...
    fun adicionarJogo(jogo: Jogo) {
        val entity = JogoEntity(jogo.titulo.toString(), jogo.capa.toString(), jogo.preco.toDouble(), jogo.descricao.toString())
...
//    fun adicionarJogo(jogo: Jogo) {
//        val conexao = Banco.obterConexao()
//        val insert = "INSERT INTO JOGOS (TITULO, CAPA, PRECO, DESCRICAO) VALUE (?, ?, ?, ?)"
//
//        if (conexao != null) {
//            try {
